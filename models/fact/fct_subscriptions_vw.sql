...
SELECT
    ...
    CASE
        ...
        WHEN canc.cancellation_created_by_user_id = users.user_id THEN 'Canceled by Customer'
        WHEN
            subs.cancellation_details_reason = 'cancellation_requested'
            OR (canc.subscription_id IS NOT NULL AND canc.cancellation_created_by_user_id <> users.user_id)
